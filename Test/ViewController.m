...
- (IBAction)pressButton:(UIButton*)sender
{
    if ([[sender titleForState:UIControlStateNormal] isEqualToString:@"Tap"]) {
        ...
        if ([sender addCircularProgressViewWithMax:31415 currentPosition:3141 newPosition:31415 animationDuration:200. repeat:NO frame:sender.bounds corners:NO colorsAndWidth:dict])
