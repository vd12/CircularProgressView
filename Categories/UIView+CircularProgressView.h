...
@interface UIView (CircularProgressView)
...
-(BOOL) setCircularProgressViewCurrentPosition:(NSUInteger)newCurrent newColorsAndWidth:(NSDictionary*)colors animationDuration:(NSTimeInterval)duration repeat:(BOOL)repeat;
